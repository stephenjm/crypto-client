package com.stephenjm.crypto.spring;

import com.stephenjm.crypto.KmsClient;
import com.stephenjm.crypto.crypto.AesGcmCipher;
import com.stephenjm.crypto.crypto.EnvelopeEncryption;
import com.stephenjm.crypto.model.EnvelopeEncryptionResult;
import com.stephenjm.crypto.model.GenerateDataKeyRequest;
import com.stephenjm.crypto.model.GenerateDataKeyResponse;
import com.stephenjm.crypto.model.KeySpec;
...
public class EnvelopeEncryptionFacade {
    ...
    private EnvelopeEncryptionResult encryptWithCachedKey(byte[] plaintext, String keyId, CachedDataKey cachedKey) {
        ...
        byte[] plaintextKey = kmsClient.decrypt(
            com.stephenjm.crypto.model.DecryptRequest.builder()
